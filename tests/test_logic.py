...
def test_edit_account(user_instance):
    ...
    expected_output = '''Instagram --> User Name: Test 2, Password: 654321'''
    assert user_instance.edit_account(social_media=social_media_input, user_name=user_name_input, password=password_input) == "Edited successfully"
    assert user_instance.view_account(social_media=social_media_input) == expected_output
